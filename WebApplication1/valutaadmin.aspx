        ...
        <asp:UpdatePanel runat="server" ID="updatepanel1">
            <ContentTemplate>
                ...
                <asp:Panel ID="secondPage" runat="server" Visible="false">
                    ...
                    <br />
                    <br />
                    <asp:DropDownList ID="ddlYear" runat="server" CssClass="selectpicker" data-live-search="true"></asp:DropDownList>
                    &nbsp;
            <asp:DropDownList ID="ddlMonth" runat="server" CssClass="selectpicker" data-live-search="true"></asp:DropDownList>
                    <br />
                    <br />
                    &nbsp;
            <br />
            ...
            <br />
                    ...
                    <asp:GridView ID="GridViewCurrency" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="false">
                        ...
                        <Columns>
                            <asp:BoundField HeaderText=" Currency Code " ShowHeader="true" DataField="CurrencyCode" />
                            ...
                            <asp:TemplateField HeaderText=" Closing Rate ">
                                <ItemTemplate>
                                    <asp:TextBox ID="txtClosing" runat="server"></asp:TextBox>
                                </ItemTemplate>
                            </asp:TemplateField>
