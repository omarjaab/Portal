<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Appinfo.aspx.cs" Inherits="WebApplication1.Appinfo" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
  ...
  <ul>
    ...
    <li><a href="#tabs-2">Area</a></li>
      <li><a href="#tabs-3">Applications</a></li>
    <li><a href="#tabs-4">Application-info</a></li>
      <li><a href="#tabs-5">Contact</a></li>
        <li><a href="#tabs-6">Defintion</a></li>
      <li><a href="#tabs-7">Content</a></li>
  </ul>
  <div id="tabs-1" >
